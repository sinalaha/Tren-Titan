  ...
  return (
    <main className="mx-auto w-full max-w-4xl space-y-6 px-4 py-6 sm:px-6">
      <GlassCard className="space-y-4 p-6" glow="cyan">
        ...
        <p className="text-sm text-white/75">{t("legal.privacyP1")}</p>
        <p className="text-sm text-white/75">{t("legal.privacyP2")}</p>
        <p className="text-sm text-white/75">{t("legal.privacyP3")}</p>
      </GlassCard>
    </main>
  );
}
